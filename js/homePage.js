...
function dojoInit() {
    ...
    requestLocationLayerName = responseObject.RequestLocationLayerName;
    ...
    if (dojo.isIE < 9) {
    } dojo.byId('txtSelectedRequestLocation').style.lineHeight = "23px";
}
...
function initializeMap() {
    ...
    var handle = dojo.connect(serviceRequestLayer, "onUpdateEnd", function (features) {
        ...
        CreateRequestLocationList(serviceRequestLayer.fields);
        HideProgressIndicator();
